      ...
      <div className="featured">
        ...
        <div className="container">
          ...
          <div className="span-3 img-details">
            <div className="top">
              <h2>Smart blue bells in attibele, Bangalore south</h2>
              <p>House for Sale</p>
              <p className="price">₹96,77,000</p>
            </div>
        ...
        <div className="container">
          ...
          <div className="span-3 img-details">
            <div className="top">
              <h2>Dwarakamai Apex Villas, Bangalore east</h2>
              <p>House for Sale</p>
              <p className="price">₹2,66,77,000</p>
            </div>
            <div className="info-grid">
              <div>
                <div className="info">
